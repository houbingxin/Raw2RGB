...
input_path = os.path.join('FullResTestingPhoneRaw')
#%%

mdl_path = 'C:/Users/houbi/Documents/research/Raw2RGB/FgSegNet_S/test_b10_1000.h5'

for imageN in range(0,len(input_path)):
    ...
    model = load_model(mdl_path,compile=False)  # ,custom_objects={'MyUpSampling2D': MyUpSampling2D}) # load the saved model that is trained with 50 frames
    ...
    a = 'C:/Users/houbi/Documents/research/Raw2RGB/FullResTestingPhone_RGB/'+str(imageN)+'.png'
    j = Image.fromarray(x)
