...
# This code is for AIM2019 Raw2RGB, 224*224 Raw image to RGB
...
input_path = os.path.join('TestingPhoneRaw') # you need to set the input folder
...
for frame_idx in range(0,len(probs)): # display frame index
    ...
    a = 'C:/Users/houbi/Documents/research/Raw2RGB/TestingPhone_RGB/'+ name[frame_idx]+'.png'  # you need to set the result image saving folder
